package com.example.pjt_premier02.config.security;
...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(authorize -> authorize
				...
				.requestMatchers("/","/league/list","/league/view/**","/club/list","/club/view/**","/images/**", "/member/signup", "/board/list/**", "/board/view/**","/auth/refresh","/board/contentdownload/**").permitAll()
